        ...
        <div className="space-y-10">
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="flex-1 md:max-w-sm glass rounded-3xl p-6 shadow-card hover:scale-[1.02] transition ml-16 md:ml-0">
...
function Component() {
  return <PageShell><WorkflowPage /></PageShell>;
}

// re-export wrapped component
